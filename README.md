...
```bash
git clone https://github.com/777IlliaSher777/office-pass-system.git
```
...
У процесі виконання лабораторної роботи було реалізовано консольну систему створення перепусток для офісу із використанням сучасного архітектурного підходу Hexagonal Architecture (Ports and Adapters).

Проєкт демонструє:
- розділення відповідальностей;
- використання інтерфейсів;
- відокремлення бізнес-логіки від інфраструктури;
- використання use case підходу;
- побудову системи з чіткими межами між шарами.
